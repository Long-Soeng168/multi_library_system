                                ...
                                <TableCellActions>
                                    {item.deleted_at ? (
                                        <RecoverItem
                                            ...
                                            recoverPath={`/admin/item-types/${item.id}/recover`}
                                            permission=""
                                        />
                                    ) : (
                                        <>
                                            ...
                                            <EditItemButton
                                                url={
                                                    hasPermission('item view')
                                                        ? `/admin/item-types/${item.id}/edit`
                                                        : `/dashboard/library/${user_library?.code}/item-types/${item.id}/edit`
                                                }
                                                permission=""
                                            />
                                            ...
                                            <ViewItemButton
                                                url={
                                                    hasPermission('item view')
                                                        ? `/admin/item-types/${item.id}`
                                                        : `/dashboard/library/${user_library?.code}/item-types/${item.id}`
                                                }
                                                permission=""
                                            />

                                            {/* Delete Item */}
                                            <DeleteItemButton deletePath="/admin/item-types/" id={item.id} permission="" />
                                        </>
                                    )}
                                </TableCellActions>
                                <TableCell>
                                    <TableCellAvatar
                                        ...
                                        alt={item.name}
                                        image={`/assets/images/item_types/thumb/${item.image}`}
                                    />
                                </TableCell>
