...
import { BookOpen, CheckCircle2, Headset, LifeBuoy, Settings } from 'lucide-react';
                    ...
                    <div className="mx-auto max-w-7xl">
                        ...
                        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
                            {services.map((service, idx) => (
                                <div className="group flex flex-col rounded-xl border border-gray-100 bg-white p-8 shadow-md transition-all hover:-translate-y-1 hover:border-transparent hover:shadow-xl dark:border-gray-800 dark:bg-gray-900 dark:shadow-none dark:hover:border-gray-700">
